  ...
  return (
    <> 
      <div className="flex flex-col items-center justify-center max-w-sm m-4">
        <div className="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" style={{ backgroundImage: `url(${item.image})`}} / >
        <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
            <h3 className="py-2 text-xs font-bold tracking-wide text-center text-gray-800 uppercase dark:text-white">{item.title}</h3>
